...
Despite the digitization of certain processes in traditional banks, I find it ironic that one has to go in-branch to open an account in some territories, and then sign up for electronic banking to be able to access digital banking services. Nonetheless, as our generation likes to say “*a win is a win”* and the ease and convenience that comes with electronic banking cannot be underrated, irrespective of the process to get there.
