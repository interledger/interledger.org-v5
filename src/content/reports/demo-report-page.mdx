...
[^1]:
    Average cost to send 1 USDT (Tether, the largest stablecoin pegged to the US dollar) on August 5, 2025 per GasFeesNow. [https://gasfeesnow.com](https://gasfeesnow.com/)

     

[^2]:
    Average price for a $200 bank initiated cross-border transfer, according to the World Bank (Q3, 2024). [https://remittanceprices.worldbank.org/sites/default/files/rpw_main_report_and_annex_q324.pdf](https://remittanceprices.worldbank.org/sites/default/files/rpw_main_report_and_annex_q324.pdf)
