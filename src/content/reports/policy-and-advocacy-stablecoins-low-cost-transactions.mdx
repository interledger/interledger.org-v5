...
| **Highly Volatile Cryptocurrencies Are Not Suitable for Payments:&#xA0;**&#xE000;<br />Cryptocurrencies with rapidly fluctuating value are impractical for everyday commerce. Their instability makes it difficult for users to budget or transact reliably. These assets are not suitable for use in Interledger-enabled payments.                                     | **Stablecoins Must Be Regulated:&#xA0;**&#xE000;<br />The Interledger Foundation only supports the use of stablecoins that are fully backed by liquid fiat reserves and issued under clear regulatory supervision. This ensures that their circulating supply is trustworthy and redeemable.                                                                          |
