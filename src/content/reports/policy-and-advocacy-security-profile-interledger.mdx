...
[^1] In 2022, Coil Technologies, Inc. reported having processed 78 billion Interledger Protocol transactions. Because the Interledger Protocol is decentralized and privacy-preserving technology, the Interledger Foundation does not have access to total global transaction data. Usage is estimated with optional, opt-in Rafiki telemetry and standard inference techniques akin to those applied for Internet traffic.

[^2] See our engineering blog: [https://interledger.org//blog/rafikis-first-security-audit/](/blog/rafikis-first-security-audit/)<br />
