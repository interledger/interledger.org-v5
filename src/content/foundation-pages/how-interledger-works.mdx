...
description: 'The Interledger Protocol. Route payments across networks, currencies, and account types without custom integrations or vendor lock-in.'
...
heroImageBlur: 'data:image/webp;base64,UklGRoAAAABXRUJQVlA4IHQAAADwAwCdASoUAA0APu1iqU2ppaOiMAgBMB2JYgCxGwABhBHgCaaGwcAAAMvEVMIqnUS5KC8wb0NghJrZDF44SFmAuI2QtnZVzKVKJR8X7XREIdL+EXi3PZzGQgEcKmBdAxqQAKyeVypyhMLkzUM1LyDMFyZ4AA=='
locale: 'en'
---
...
<CardGrid
  ...
  ariaLabel="Explore the technology, grant funding, and our policy work."
  variant="Navigation"
  columns="Three"
>
  <NavigationCard
    heading="Go deeper on the technology"
    buttonUrl="/tech/overview"
    buttonText="Interledger Tech"
    buttonExternal={false}
  />
  <NavigationCard
    heading="Fund your work"
    buttonUrl="/grant/our-grantmaking/"
    buttonText="Our Grantmaking"
    buttonExternal={false}
  />
  <NavigationCard
    heading="How we influence the rules"
    buttonUrl="/policy-and-advocacy"
    buttonText="Policy & Advocacy"
    buttonExternal={false}
  />
</CardGrid>
