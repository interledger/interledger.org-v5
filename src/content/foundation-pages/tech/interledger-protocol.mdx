...
heroImageBlur: 'data:image/webp;base64,UklGRpYAAABXRUJQVlA4IIoAAAAwBACdASoUAA0APu1iqU2ppaOiMAgBMB2JZACdAywBiIju1JOveacsoAAA/rxJRhBwUze3XoYYW9x0oVCSFXc01WJ4sZsptTFzsYRgVY98b7HSk1gTEQajsdwS+MHIovtlo73TxPBitmTLNbBbq+Muy1Amx7EMdv6mYYDZsCcoRiUH6fysVc818AA='
...
<ImageBlock
  src="/uploads/img/original/06_Interledger_Protocol_ILP_stack_architecture_F_1_e1e99e8469.jpg"
...
>
  The Interledger Protocol, the Open Payments standard, and the tools built on
  them are all open source. Anyone can read the code, audit the standards,
  propose changes, and contribute.
</CtaStrip>
