...
description: 'New research explores how trust and transparency shape financial inclusion in Colombia.'
date: 2026-06-30
pathSlug: why-access-isnt-enough-new-research-project-explore-barriers-financial-inclusion-colombia
featured: false
locale: en
featureImage: '/img/foundation-blog/architecture-trust-banner.png'
featureImageBlur: 'data:image/webp;base64,UklGRpAAAABXRUJQVlA4IIQAAACwAwCdASoUAAsAPu1iqU2ppaOiMAgBMB2JbACdABLPgpZh0WwmYADMFQjGIo+wQhXb0wHZtJlZV0EavYAhacbqene4baVZXjfJJc0nh3TpA5Ov8LLM6MqIM1q0RB5LwOYAUDfljFqZGbYToLvlGEDELyc8nAt50UDe4xRDKWj+Y99MAAA='
featureImageAlt: 'A heart-with-wings sculpture frames a city skyline in the background.'
categories:
  - Thought Leadership
  - News
relatedArticles:
