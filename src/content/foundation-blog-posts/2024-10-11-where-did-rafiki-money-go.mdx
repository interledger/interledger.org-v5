...
date: 2024-10-11
pathSlug: where-did-rafiki-money-go
featured: false
locale: en
articleBios:
  - author: Timea Nagy
    link: https://www.linkedin.com/in/nagy-timea-35483024
categories:
  - Engineering
relatedArticles:
  - rafiki-beta-release
...
![Old to new URL mapping](/img/foundation-blog/2024-10-11/url-change.png)
...
<VideoEmbed
  url="/img/foundation-blog/2024-10-11/hover-effect.mp4"
...
![Login page for redesigned Test Wallet in light mode](/img/foundation-blog/2024-10-11/test-wallet-light.png)

![Login page for redesigned Test Wallet in dark mode](/img/foundation-blog/2024-10-11/test-wallet-dark.png)

![Login page for redesigned Test Boutique in light mode](/img/foundation-blog/2024-10-11/test-boutique-light.png)

![Login page for redesigned Test Boutique in dark mode](/img/foundation-blog/2024-10-11/test-boutique-dark.png)
