...
date: 2025-09-30
pathSlug: wallet-address-smart-redirect
featured: false
locale: en
articleBios:
  - author: Cozmin Ungureanu
    link: https://www.linkedin.com/in/nodejs-dev/
categories:
  - Engineering
...
![Interledger Payment Page](/img/foundation-blog/2025-09-30/ilp-payment-page.png)
...
<CodeBlock language="bash" code={`WALLET_ADDRESS_REDIRECT_HTML_PAGE="https://interledgerpay.com/payment-choice?receiver=%ewa"`} />
