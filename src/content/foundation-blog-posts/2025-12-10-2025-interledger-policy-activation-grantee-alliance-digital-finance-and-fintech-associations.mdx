...
date: 2025-12-10
pathSlug: 2025-interledger-policy-activation-grantee-alliance-digital-finance-and-fintech-associations
featured: false
locale: en
featureImage: '/img/foundation-blog/policy-activation-grantee-banner.jpg'
featureImageBlur: 'data:image/webp;base64,UklGRmQAAABXRUJQVlA4IFgAAACwAwCdASoUAAsAPu1iqU2ppaOiMAgBMB2JZQAAXGOvyNT+m9rkAAD+79VJS6LWJ5rvdXzEPzWEjsUhFX4L7SLHs+u0NiD0DSWS2/MpngJeWG4c0c4eQAAA'
featureImageAlt: 'Policy Activation Grantee'
articleBios:
...
relatedArticles:
  ...
  - interledger-foundation-and-small-foundation-partner-alliancedfa-strengthen-inclusive-digital
---

<Paragraph>

_The Interledger Foundation has awarded _[_Alliance of Digital Finance and Fintech Associations_](http://www.alliancedfa.org)_ (AllianceDFA) to be the first recipients of an **Interledger Policy Activation Grant**. This grant will enable them to lead a new global initiative to make Instant Payment Systems (IPS) more inclusive and accessible to fintechs and non-banks._
...
- **A global assessment** of fintech IPS integration, shaped by interviews with fintech associations and key stakeholders across Latin America, Africa, and Asia. This assessment will document both successes and challenges and provide actionable recommendations to improve market access.
- **Identification of deeper solutions** that can serve the global Fintech ecosystem to increase inclusive governance.
- **Membership growth** and outreach to strengthen the AllianceDFA’s global representation, particularly in Latin America.
