...
date: 2025-06-04
pathSlug: reflections-2025-payments-canada-summit
featured: false
locale: en
featureImage: '/img/foundation-blog/payments-canada-group-photo.png'
featureImageBlur: 'data:image/webp;base64,UklGRqYAAABXRUJQVlA4IJoAAADQAwCdASoUAA4APu1iqU2ppaOiMAgBMB2JQBYdsYdI3h+IInYVElAA/e0K63ssIb9tJnqlr2v3KosZw8fC5o8sDqhtyPXnhKDh5VLiWtSG6sYD9gVcT4O3CkQwLk5IgpoOXjSdf6llIzNhiwVAEwgtuDY+7u3qrac/Xq/A0dhCAwMTpXFQuhJVnrxZyylmgnTjSPU8IOouAAAA'
...
For the Interledger Foundation, participating in this year’s staging was strategic and a mission driven choice. As a global non-profit committed to advancing open, accessible digital financial systems, the Foundation places a high priority on cross-border payments which was one of the six deep dives and session themes of the Summit. **ILF sees cross-border remittances, particularly those sent by migrant workers, as a critical area where interoperability can drive meaningful change**. As such, we convened a panel discussion on the topic “_Interoperable Cross-Border Transfers: Revolutionizing Migrant Remittances_”. It was only right, given that Canada is a major remittance-sending country, to use the platform to highlight to an esteemed audience how within the[ Interledger ecosystem](/tech/overview), open protocols and user-focused innovations are transforming remittance systems to be faster and more inclusive for all.
