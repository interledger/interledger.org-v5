...
<ImageBlock
  src="/img/foundation-blog/2026-03-26/responsibilites.png"
...
[Open Payments](/tech/open-payments) is an API standard for allowing **third-party clients** to initiate payments between wallet addresses.
...
[ILP](/developers/get-started/) is a protocol for transferring payments (through packets).
...
<ImageBlock
  src="/img/foundation-blog/2026-03-26/sequence-diagram.png"
