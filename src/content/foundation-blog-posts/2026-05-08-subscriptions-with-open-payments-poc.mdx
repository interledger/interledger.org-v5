...
- [Wallet](https://wallet.interledger-test.dev/) - which owns wallet-specific experiences, wallet addresses, transactions, and direct Rafiki and GateHub integrations.
- [Boutique](https://boutique.interledger-test.dev/) - which owns the storefront, catalog, checkout, orders, and boutique-side payment records.
...
[![The Test Network Architecture Diagram](/img/foundation-blog/2026-05-08/testnet-architecture-diagram.png)](/img/foundation-blog/2026-05-08/testnet-architecture-diagram.png)
...
[![The Test Network One Time Payment Boutique Baseline Flow Diagram](/img/foundation-blog/2026-05-08/testnet-one-time-payment-baseline-flow-diagram.png)](/img/foundation-blog/2026-05-08/testnet-one-time-payment-baseline-flow-diagram.png)
...
[![The Test Network Open Payments Subscriptions Architecture Diagram](/img/foundation-blog/2026-05-08/testnet-open-payments-subscriptions-architecture-diagram.png)](/img/foundation-blog/2026-05-08/testnet-open-payments-subscriptions-architecture-diagram.png)
...
[![Subscriptions Activation Flow Diagram](/img/foundation-blog/2026-05-08/subscriptions-activation-flow-diagram.png)](/img/foundation-blog/2026-05-08/subscriptions-activation-flow-diagram.png)
...
[![Subscriptions Retry Flow Diagram](/img/foundation-blog/2026-05-08/subscriptions-retry-flow-diagram.png)](/img/foundation-blog/2026-05-08/subscriptions-retry-flow-diagram.png)
...
![Subscription detail view in a PAST_DUE state with separate re-authorize and retry actions](/img/foundation-blog/2026-05-08/subscription-with-retry-re-authorize-actions.png)

_Subscription detail view showing a `PAST_DUE` subscription with re-authorize and retry presented as separate user actions._

## Subscription state model

The lifecycle now spans multiple user interactions and background jobs instead of a single checkout.

[![Subscriptions State Model Flow](/img/foundation-blog/2026-05-08/subscriptions-state-model-diagram.png)](/img/foundation-blog/2026-05-08/subscriptions-state-model-diagram.png)
...
![Subscription detail view with payments history](/img/foundation-blog/2026-05-08/daily-subscription-with-payments-history.png)

_Subscription detail view showing a daily subscription service with daily payments in the payment history section._
