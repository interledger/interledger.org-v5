...
date: 2025-11-25
pathSlug: building-real-solutions-interledger-hackathon-winners-2025
featured: false
locale: en
featureImage: '/img/foundation-blog/ilf-hackathon-banner.jpg'
featureImageBlur: 'data:image/webp;base64,UklGRqgAAABXRUJQVlA4IJwAAAAQBACdASoUAA8APu1iqU2ppaOiMAgBMB2JYwCsMoAlxg3E/8dQ9JAMAAD+Ai+c4kDJea0/SOyo3r7FQHfW4TxWidjrhM5VAW8obs13tc+VRwZdcelso7xp8l5rvgALwJ9cb1zGzDVEpkRUQc3/TMR7+tPnyMgqRPnzAnVjCroPsgnL+QtLxxosiKS2FTYMwLACMXiphWMX0uIYAAA='
...
The challenge was clear: how can open-source tools like the [Interledger Protocol (ILP)](/tech/interledger-protocol) and [Open Payments API](https://openpayments.dev/overview/getting-started/) help reduce cash dependency, lower remittance costs, and improve digital acceptance for small businesses?
...
Judges from across technology, finance, and academia reviewed each project for idea quality, strategic impact, and implementation. The panel included Alex Lakatos (Chief Technical Officer, Interledger Foundation), [Roberto Valdovinos](/summit/2025/speakers/roberto-valdovinos) (CFO, People’s Clearinghouse), [Dr. Andrew Mangle](https://www.linkedin.com/in/andrew-mangle/) (Associate Professor, Bowie State University), [Afua Bruce](https://www.linkedin.com/in/afua-bruce/) (Executive Advisor), and [Sabine Schaller](/team/) (Engineering Manager, Interledger Foundation).
