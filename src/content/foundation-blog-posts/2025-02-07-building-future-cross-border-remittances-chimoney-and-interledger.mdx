...
date: 2025-02-07
pathSlug: building-future-cross-border-remittances-chimoney-and-interledger
featured: false
locale: en
featureImage: '/img/foundation-blog/chimoney.svg'
featureImageBlur: 'data:image/webp;base64,UklGRpAAAABXRUJQVlA4WAoAAAAQAAAAEwAACgAAQUxQSBoAAAABF3D7/4iIQkHbNkz589gz1CGI6H9qOr+OAlZQOCBQAAAA8AMAnQEqFAALAD7tYqlNqaWkIjAIATAdiWIAnTKAAf8dQt+NBL/UAAD+y+VxNXfvWKtuuAIrcpP7g9zPtRtfwD083Y9atkIABQS6vcnQAAA='
featureImageAlt: ''
categories:
...
relatedArticles:
  ...
  - revolutionizing-global-payouts-and-boosting-financial-inclusion
  - redefining-financial-inclusion-chimoney
---

<Paragraph>

_This blog was written in partnership with Chimoney_
...
_Step 1: Multi-Currency Wallet Setup_
...
_Step 2: Issue Payment Pointers_
...
_Step 1: Multi-Currency Wallet Creation_
...
_Step 3: Instant Value Transfer_
