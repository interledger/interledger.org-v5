...
![Interledger network diagram](/img/foundation-blog/2024-08-13/network.png)
...
![Interledger stack vs the Internet stack](/img/foundation-blog/2024-08-13/stack.png)
...
- [Bilateral Transport Protocol](/developers/rfcs/bilateral-transfer-protocol/) (BTP): Uses WebSocket-based communication between connectors.
- [ILPoverHTTP](/developers/rfcs/ilp-over-http/): Utilizes HTTPS for communication between connectors.
...
The core of the Interledger stack is the [Interledger Protocol](/developers/rfcs/interledger-protocol/) (ILP). This protocol splits larger payments into smaller packets, whose content it prescribes, and defines a two-phase transfer protocol.
...
![Single-phase transfer diagram](/img/foundation-blog/2024-08-13/transfer.png)
...
![Two-phase transfer diagram](/img/foundation-blog/2024-08-13/2p-transfer.png)
...
The transport layer builds on ILP by providing additional functionalities for managing value transfer. The only supported protocol at the moment is the [STREAM Protocol](/developers/rfcs/stream-protocol/) (Streaming Transport for Real-time Exchange of Assets and Messages).

![STREAM protocol animation](/img/foundation-blog/2024-08-13/stream.gif)
...
[SPSP](/developers/rfcs/simple-payment-setup-protocol/) simplifies the process of setting up payments. When a GET request is made to a URL associated with a payment pointer using the SPSP request headers, SPSP defines what needs to be returned.
...
For an in-depth introduction to Open Payments, check out [Sarah’s fantastic blog post](/blog/simple-open-payments-guide/). If you would like a more high level overview of GNAP and why we are using it with Open Payments, check out [Nathan's Cinderella Story of Finding a Fitting Authorization Method](/blog/open-payments-cinderella-story/).
...
![Web Monetization in the Interledger stack](/img/foundation-blog/2024-08-13/wm.png)
...
![Components of the Interledger stack included in Rafiki](/img/foundation-blog/2024-08-13/rafiki.png)
