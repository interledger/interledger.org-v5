...
For an in-depth introduction to Open Payments, check out [Sarah’s fantastic blog post](https://interledger.org/blog/simple-open-payments-guide/). If you would like a more high level overview of GNAP and why we are using it with Open Payments, check out [Nathan's Cinderella Story of Finding a Fitting Authorization Method](https://interledger.org/blog/open-payments-cinderella-story/).
