...
date: 2024-09-20
pathSlug: collaborative-work-week-peoples-clearinghouse
featured: false
locale: en
featureImage: '/img/foundation-blog/pch-ww-feature.jpg'
featureImageBlur: 'data:image/webp;base64,UklGRpQAAABXRUJQVlA4IIgAAACwAwCdASoUAA0APu1iqU2ppaOiMAgBMB2JYwCdMoAB/3T7UIPzwAD42nZLfRDCVAmVs6Uk8NP+ZkmHOlL7xrO2+IkZPR8N34tnq4UOTa8QEwjixT/LlH3SuNJ+z8UVygpFfTZoDlp8qYe9IUT7MMKk5XuKYk+O7+pi0iF/1cv5p6ea+KHqAAAA'
...
The end of the workday was marked by a lively surprise orchestrated by the PCH team right outside the coworking space: a band leading us on a parade through town — a _calenda_. Complete with _monos de calenda_—large, traditional paper-mache puppets—a variety of instruments, we followed the band through the streets. As we went, onlookers from restaurants and houses joined in, adding to the vibrant and festive atmosphere of the already colorful town.
...
For a comprehensive demo and presentation of all the work that has been done, as well as future plans, the People’s Clearinghouse will be presenting at the [ILF Summit](/summit) in Cape Town, 26-27 October.
