...
date: 2025-05-22
pathSlug: introducing-besspay-plugin-project
featured: false
locale: en
featureImage: '/img/foundation-blog/BessPay-banner.jpg'
featureImageBlur: 'data:image/webp;base64,UklGRk4AAABXRUJQVlA4IEIAAABwAwCdASoUAAsAPu1iqU2ppaOiMAgBMB2JZwAAW+uF6FGMlAAA/vHJZ4EqBw3Be2bqupMJGyRvLzQbcA2aysfgAAA='
featureImageAlt: 'Bess Pay and Interledger Logos'
categories:
  - Grantmaking
relatedArticles:
  - grantee-spotlight-boost-msmes-besspay-plugins-seamless-payment-solutions
...
This work is supported by a grant from the [Interledger Foundation’s Digital Financial Services](/grant/innovation/financial-services) (DFS) Unlocked program and will be piloted through our Sharetribe-powered marketplace, SouthLink, which will connect MSME sellers in Africa, the Caribbean, and Southeast Asia with global buyers seeking authentic goods, services, and experiences.
