...
![Configuration flow](/img/foundation-blog/2025-12-09/publisher-tools-schema.png)
...
<CodeBlock language="typescript" code={`import { PaymentWidget } from '@tools/components'
...
<CodeBlock language="typescript" code={`function appendMonetizationLink(walletAddressUrl: string) {
...
<CodeBlock language="typescript" code={`// Generate a quote
