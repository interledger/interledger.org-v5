...
<CodeBlock
  language="typescript"
  code={`import { Ioc, IocContract } from '@adonisjs/fold'
...
<CodeBlock
  language="typescript"
  code={`const incomingPaymentRoutes = await this.container.use(
...
<CodeBlock
  language="typescript"
  code={`const grantRoutes = await this.container.use('grantRoutes')
...
