...
date: 2024-09-23
pathSlug: rafiki-low-level-intro
featured: false
locale: en
articleBios:
  - author: Nathan Lie
...
- [Interledger](/developers/get-started/#how-does-interledger-work)
...
<ImageBlock
  src="/img/foundation-blog/2024-09-23/rafiki-architecture-diagram.png"
...
<CodeBlock language="typescript" code={`import { Ioc, IocContract } from '@adonisjs/fold'
...
<CodeBlock language="typescript" code={`const incomingPaymentRoutes = await this.container.use(
...
<CodeBlock language="typescript" code={`const grantRoutes = await this.container.use('grantRoutes')
...
![A screenshot of the Rafiki Admin UI](/img/foundation-blog/2024-09-23/rafiki-admin-screen.png)
...
<CodeBlock language="typescript" code={`pnpm localenv:compose up`} />
...
<ImageBlock
  src="/img/foundation-blog/2024-09-23/bruno-screen.png"
...
![A screenshot of the Mock ASE's consent screen](/img/foundation-blog/2024-09-23/mock-ase-consent-screen.png)
...
With even more luck, this article will be relevant for quite some time after publication, but if it isn't, it can serve as a recent entry in the [Interledger graveyard](/blog/simplifying-interledger-the-graveyard-of-possible-protocol-features).
