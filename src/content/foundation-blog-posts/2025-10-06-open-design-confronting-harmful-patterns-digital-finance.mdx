...
date: 2025-10-06
pathSlug: open-design-confronting-harmful-patterns-digital-finance
featured: false
locale: en
featureImage: '/img/foundation-blog/confronting-harmful-patterns-banner.svg'
featureImageBlur: 'data:image/webp;base64,UklGRpoAAABXRUJQVlA4WAoAAAAQAAAAEwAACgAAQUxQSCoAAAABL6AgbQPGv+V2x0ZExNl+KIYkiTmVCJAMjmH9ZfZ5ABH9z0stkDzeMTBWUDggSgAAANADAJ0BKhQACwA+7WKpTamlpCIwCAEwHYlkAJ0yhHAAGSYN+M4QAAD+f66Kjx7PshWFvoUrQjGn/qsWbYLa36ceyd25TqDeZAAA'
featureImageAlt: ''
categories:
  - Thought Leadership
relatedArticles:
  - multiple-sides-friction-good-bad-and-how-use-it
...
_“There are differences between ‘poor’ design or ‘bad design’ versus harmful design patterns; harmful design often nudges, confuses or manipulates the user into making a decision they normally wouldn’t make. An app that hides fees, or tricks a user into paying more for something than they should would be examples of harmful design patterns. Having UI, logos, or color choices that feel out of date might be ‘bad’ design’ but that doesn’t make it a harmful design pattern. Burying a necessary setting, depending upon what that setting is, could be a harmful design pattern. Like friction, it all depends upon the context.”_
