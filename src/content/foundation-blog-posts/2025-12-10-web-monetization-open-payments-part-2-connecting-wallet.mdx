...
<CodeBlock language="html" code={`<link rel="monetization" href="https://example-wallet.com/my-wallet" />`} />
...
<CodeBlock language="javascript" code={`function getLinkElements() {
...
<CodeBlock language="typescript" code={`function documentMutationCallback() {
