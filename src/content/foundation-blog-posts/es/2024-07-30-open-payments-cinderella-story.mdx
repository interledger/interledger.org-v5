...
Sin embargo, a medida que los métodos de [Open Payment](https://openpayments.dev/introduction/overview/) para describir y gestionar pagos fueron tomando forma, comenzaron a evidenciarse las limitaciones de OAuth 2.0 para ese caso de uso. Para entender cuáles son, repasemos primero las características de OAuth 2.0 que lo llevaron a alcanzar una gran popularidad.
...
Para obtener más información sobre Open Payments en general, considere consultar la [documentación](https://openpayments.dev/introduction/overview/).
