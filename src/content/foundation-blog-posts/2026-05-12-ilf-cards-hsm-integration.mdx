...
Please read the [Rafiki Card Integration BLOG](https://interledger.org/blog/rafiki-card-integration/) for background on Rafiki Card Payments if you haven't already.

![ILF + Cards](/img/foundation-blog/2026-05-01/hsm.png)
...
![Rafiki and HSM Key Protection Architecture](/img/foundation-blog/2026-05-01/hsm-architecture.svg)
