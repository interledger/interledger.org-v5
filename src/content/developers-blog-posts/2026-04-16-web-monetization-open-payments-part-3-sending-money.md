...
date: 2026-04-16
pathSlug: web-monetization-open-payments-part-3-sending-money
locale: en
authors:
  - Sid Vishnoi
author_urls:
...
While the math is correct, the economics isn't quite right. We can't send an amount as small as $0.0004167, as most wallets can only represent amounts up to 2 decimals (matching the standard cent-based format of fiat currencies like the Dollar or Euro). In Open Payments, it is represented as `assetScale = 2`. So, instead of trying to send $0.0004167 every second, we'll send $0.01 every 24 seconds (as $0.01 every 24s == $0.0004167 every 1s).\
...
<iframe src="https://labs.sidvishnoi.com/web-monetization/open-payments-part-3-sending-money/iframes-flow" style="width: 100%; aspect-ratio: 500/843; aspect-ratio: 1200/500; border: none" loading="lazy" scrolling="no"></iframe>
