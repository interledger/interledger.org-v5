...
date: 2025-09-09
pathSlug: memorable-wallet-addresses-custom-domain
locale: en
authors:
  - Sid Vishnoi
author_urls:
...
![Illustration showing turning long wallet addresses to custom domain payment pointers](/img/blog/2025-09-09/memorable-wallet-addresses-on-own-domain.png)
...
![Screenshot showing Cloudflare dashboard with the Page rule editor showing setup of my domain using a redirect to my GateHub wallet](/img/blog/2025-09-09/cloudflare-page-rule.png)
...
![Screenshot of Cloudflare dashboard with a transform rule to support CORS for our wallet address](/img/blog/2025-09-09/cloudflare-transform-rule.png)
