...
![Old to new URL mapping](/img/blog/2024-10-11/url-change.png)
...
<video
  src="/img/blog/2024-10-11/hover-effect.mp4"
  controls
  autoplay
  loop
  muted
...
<div style="display:flex;gap:var(--xl)">
![Login page for redesigned Test Wallet in light mode](/img/blog/2024-10-11/test-wallet-light.png)

![Login page for redesigned Test Wallet in dark mode](/img/blog/2024-10-11/test-wallet-dark.png)

</div>

<div style="display:flex;gap:var(--xl)">
![Login page for redesigned Test Boutique in light mode](/img/blog/2024-10-11/test-boutique-light.png)

![Login page for redesigned Test Boutique in dark mode](/img/blog/2024-10-11/test-boutique-dark.png)
