export const ui = {
  ...
  es: {
    ...
    'grantee.search.error':
      'No se pudo cargar la búsqueda. Inténtelo de nuevo.',
    ...
    'grantee.read_less': 'leer menos',
    'grantee.empty': 'Ningún beneficiario coincide con estos filtros.',
    'grantee.results': '{count} resultados',
    'grantee.caveat.label': '',
    'grantee.caveat.amounts': '',
    'grantee.caveat.exclusions': '',
    'aria.grantee.filters_label': 'Filtros',
    'aria.grantee.list': 'Proyectos de beneficiarios',
    'aria.grantee.tags': 'Etiquetas temáticas',
    'aria.grantee.location': 'Ubicación',
    'aria.grantee.date': 'Fecha de inicio',
