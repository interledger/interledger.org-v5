export const ui = {
  ...
  es: {
    ...
    'agenda.activityLabel': 'Actividad',
    'agenda.additionalInfoLabel': 'Información adicional',
    ...
    'contact.email.placeholder':
      'Ingresa la dirección de correo electrónico a la que deseas ser contactado/a',
    'contact.topic': 'Tema',
    'contact.topic.placeholder': 'Cualquier tema',
    ...
    'contact.message.placeholder': 'Comparte todos los detalles que puedas',
    'contact.submit': 'Enviar mensaje',
    'contact.submitting': 'Enviando…',
    'contact.success_message': '¡Mensaje enviado!',
    'contact.success_thanks':
