export const ui = {
  en: {
    ...
    'blog.search.no_results': 'No results found for "{query}"',
    'blog.search.result_count': '{count} results',
    'blog.search.error': 'Search unavailable, please try again.',
  ...
  es: {
    ...
    'blog.search.no_results': 'No se encontraron resultados para "{query}"',
    'blog.search.result_count': '{count} resultados',
    'blog.search.error': 'Búsqueda no disponible, por favor inténtelo de nuevo.',
    'blog.read_more': '',
    'blog.community.foundation.start': '',
