export const ui = {
  en: {
    ...
    'grantee.search.searching': 'Searching…',
    'grantee.search.error': 'Search could not load. Try again.',
    'grantee.search.clear': 'Clear search',
    ...
    'internalAdvert.block_label': 'Related',
    'internalAdvert.social_link': '{name} on {platform}',
    'internalAdvert.social_link_generic': 'Profile on {platform}',
    ...
    'contact.topic.policy_advocacy': 'Policy and Advocacy',
  ...
  es: {
    'site.title.foundation': 'Interledger Foundation',
    'site.title.summit': '',
    'site.title.hackathon': 'Hackathons de Open Payments',
    'site.description':
      'La Interledger Foundation construye infraestructura de pagos abierta, financia a innovadores y trabaja para que los sistemas financieros funcionen juntos, para todos.',
    'nav.home': 'Inicio',
    'nav.breadcrumb': 'Ruta de navegación',
    'nav.main': 'Navegación principal',
    'nav.summit': 'Navegación del Summit',
    'nav.hackathon': 'Navegación del Hackathon',
    ...
    'nav.submenu_toggle': 'Abrir submenú de {label}',
    ...
    'footer.press_media': 'Prensa y Medios',
    'footer.faq': 'Preguntas Frecuentes',
    'footer.resources': 'Recursos',
    'footer.learn_open_payments': 'Aprende Open Payments',
    'footer.code_conduct': 'Código de Conducta',
    ...
    'footer.slack': 'Slack de la comunidad de Interledger',
    'footer.stay_up_to_date': 'Mantente al día',
    'footer.newsletter_description':
      'Suscríbete a nuestro boletín y mantente al día con nuestras noticias y eventos',
    'footer.contact_description':
      '¿Tienes una pregunta? Tenemos respuestas. Envíanos un mensaje y te responderemos.',
    'footer.social_links': 'Redes sociales',
    'footer.nav_label': 'Navegación del pie de página',
    'footer.copyright':
      'El contenido de este sitio web y las publicaciones de la Interledger Foundation están disponibles bajo la licencia CC BY 4.0, salvo que se indique lo contrario. Las tecnologías y el software de Interledger están disponibles bajo la Apache License 2.0, salvo que se indique lo contrario. Interledger Protocol® e ILP® son marcas registradas de la Interledger Foundation.',
    'footer.logo_home': 'Ir a la página de inicio',
    'footer.logo_hackathon': 'Ir a la página principal del Hackathon',
    'blog.foundation.title': 'Blog',
    'blog.foundation.description':
      'La Interledger Foundation te trae las últimas noticias, análisis y novedades sobre la inclusión financiera digital y nuestra misión de construir equidad e inclusión dentro de una red de pagos global para proveedores de servicios financieros digitales inclusivos.',
    ...
    'blog.featured.title': 'Artículos destacados del Blog de Interledger',
    'blog.reading_time': '{readingTime} min de lectura',
    'blog.published': 'Publicado',
    'blog.updated': 'Última actualización',
    'blog.cta.heading': 'Mantente al día',
    'blog.cta.description':
      'Suscríbete a nuestro boletín y mantente al día con nuestras noticias y eventos.',
    'blog.cta.link_text': 'Suscríbete',
    'blog.lang_filter.label': 'Filtrar por idioma',
    'blog.lang_filter.english': 'Inglés',
    'blog.lang_filter.spanish': 'Español',
    'blog.lang_filter.viewing_es_posts': 'Mostrando publicaciones en español',
    'blog.lang_filter.viewing_en_posts': 'Mostrando publicaciones en inglés',
    'blog.lang_filter.es_available': 'Hay publicaciones disponibles en español',
    ...
    'blog.community.foundation.start':
      'Si quieres estar al día con todas las convocatorias y novedades de la Interledger Foundation, puedes suscribirte a nuestro',
    ...
    'blog.community.foundation.end':
      'que se realiza cada segundo miércoles del mes.',
    'blog.community.developers.start':
      'Como somos open source, puedes revisar fácilmente nuestro trabajo en',
    'blog.community.developers.middle':
      'Si el trabajo que se menciona aquí te inspiró, tus contribuciones son bienvenidas. Puedes unirte a nuestro',
    'blog.community.developers.newsletter':
      'Si quieres estar al día con todas las convocatorias y novedades de la Interledger Foundation, puedes suscribirte a nuestro',
    'blog.community.github': 'GitHub',
    ...
    'blog.categories.engineering': 'Ingeniería',
    'blog.categories.grantmaking': 'Subvenciones',
    'blog.categories.interledger-technology': 'Tecnología Interledger',
    'blog.categories.news': 'Noticias',
    'blog.categories.policy-and-advocacy': 'Política e Incidencia',
    'blog.categories.thought-leadership': 'Liderazgo Intelectual',
    'blog.related.title': 'Otros artículos relevantes',
    ...
    'prose.table_scroll_region': 'Tabla desplazable',
    'pagination.pages': '{label} páginas',
    ...
    'grantee.search.searching': '',
    'grantee.search.error': '',
    'grantee.search.clear': '',
    'grantee.filter.year': '',
    ...
    'profile.no_profiles': 'No hay perfiles para mostrar.',
    'faq.introduction': 'Introducción',
    'faq.sections_nav': 'Secciones de preguntas frecuentes',
    'faq.block_label': 'Preguntas frecuentes',
    'quote.author_image_alt': 'Retrato de {name}',
    'quote.external_link': ' (se abre en una pestaña nueva)',
    'quote.author_link_label': 'Enlace del autor',
    'report.published': '{date}',
    'report.updated': 'Última actualización {date}',
    'report.introduction': 'Introducción',
    'report.body': 'Contenido del informe',
    'report.sections_nav': 'Secciones del informe',
    'report.disclaimer_label': 'Descargo de responsabilidad',
    ...
    'eventCard.block_label': 'Detalles del evento',
    'eventCard.dateLabel': 'Fecha',
    'eventCard.timeLabel': 'Hora',
    'eventCard.locationLabel': 'Ubicación',
    'internalAdvert.block_label': '',
    'internalAdvert.social_link': '',
    'internalAdvert.social_link_generic': '',
    'aria.logo.foundation': 'Interledger Foundation',
    'aria.logo.summit': '',
    'aria.logo.hackathon': 'Interledger Hackathon',
    'aria.logo.foundation_title': 'Interledger Foundation',
    'aria.logo.github': 'GitHub de Interledger',
    'aria.opens_new_tab': '(se abre en una pestaña nueva)',
    'aria.downloads_file': '(descarga un archivo)',
    'aria.authors': 'Autores',
    'aria.author_profile': 'Perfil de {author} {newTab}',
    ...
    'homepageHero.cta_explore_grants': 'Explora nuestras subvenciones',
    'homepageHero.cta_navigation': 'Acciones destacadas',
    'hackathonHero.logo.alt': 'Open Payments Hackathon by Interledger',
    'hackathonHero.cta_navigation': 'Acciones destacadas',
    'animatedNetwork.problem.heading':
      'Nuestros sistemas financieros no se crearon para funcionar juntos',
    'animatedNetwork.problem.body_1':
      'Hoy, el dinero se mueve sobre sistemas que nunca se diseñaron para trabajar juntos. Cada uno tiene sus propias reglas, formatos y formas de conectarse.',
    'animatedNetwork.problem.body_2': 'Eso, si es que se conectan.',
    'animatedNetwork.problem.body_3':
      'Para las instituciones que intentan hacer que estos sistemas se comuniquen entre sí, es caro y lento. Para las personas que dependen de esas instituciones, es peor: costos más altos, menos opciones y, para más de mil millones de personas, ningún acceso real.',
    'animatedNetwork.problem.body_4':
      'La Interledger Foundation está cambiando eso.',
    'animatedNetwork.problem.video_title':
      'El problema que estamos resolviendo (video)',
    'pillarsSection.heading':
      'Imaginamos un mundo donde el dinero se mueve con libertad y la oportunidad llega con él.',
    'pillarsSection.card1_title': 'Construimos la Tecnología',
    'pillarsSection.card1_description':
      'Custodiamos estándares abiertos y construimos infraestructura para que los sistemas financieros se conecten una vez y se integren con muchos.',
    ...
    'pillarsSection.card3_title': 'Cambiamos el Sistema',
    'pillarsSection.card3_description':
      'Trabajamos con reguladores e instituciones para crear las condiciones que permitan que los sistemas financieros abiertos operen y crezcan en la práctica.',
