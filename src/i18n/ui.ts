...
export const ui: LanguageUi = {
  en: {
    ...
    'nav.grants': 'Grants',
    'nav.financial-services': 'Digital Financial Services',
    'nav.education': 'NextGen Higher Education',
  ...
  es: {
    ...
    'nav.financial-services': 'Servicios financieros digitales',
    'nav.education': 'Educación Superior “NextGen”',
